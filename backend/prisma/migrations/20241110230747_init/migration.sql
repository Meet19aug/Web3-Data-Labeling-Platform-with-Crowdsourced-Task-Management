...
CREATE TABLE "Task" (
    "id" SERIAL NOT NULL,
    "title" TEXT NOT NULL DEFAULT 'Select the most suitable thumbnail for the video',
...
-- AddForeignKey
ALTER TABLE "Submission" ADD CONSTRAINT "Submission_options_id_fkey" FOREIGN KEY ("options_id") REFERENCES "Options"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
